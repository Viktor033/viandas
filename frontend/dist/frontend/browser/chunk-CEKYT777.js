...
var PedidoService = class _PedidoService {
  ...
  static \u0275fac = function PedidoService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PedidoService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PedidoService, factory: _PedidoService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PedidoService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
function CartComponent_div_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "i", 9);
    \u0275\u0275elementStart(2, "p");
    \u0275\u0275text(3, "No tienes productos en el carrito.");
    \u0275\u0275elementEnd()();
  }
}
function CartComponent_div_6_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CartComponent_div_6_div_2_Template_button_click_9_listener() {
      const item_r2 = \u0275\u0275restoreView(_r1).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.removeItem(item_r2.producto.id));
    });
    \u0275\u0275element(10, "i", 17);
    \u0275\u0275text(11, " Eliminar ");
    \u0275\u0275elementEnd()()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r2.producto.nombre);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("$ ", item_r2.producto.precio, "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("x ", item_r2.cantidad, "");
  }
}
function CartComponent_div_6_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CartComponent_div_6_div_3_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r4);
      const items_r5 = \u0275\u0275nextContext().ngIf;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.confirmOrder(items_r5));
    });
    \u0275\u0275text(8);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("$ ", \u0275\u0275pipeBind2(6, 3, ctx_r2.total, "1.0-0"), "");
    \u0275\u0275advance(2);
    \u0275\u0275property("disabled", ctx_r2.isProcessing);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r2.isProcessing ? "Procesando..." : "Confirmar Pedido", " ");
  }
}
function CartComponent_div_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 4);
    \u0275\u0275template(1, CartComponent_div_6_div_1_Template, 4, 0, "div", 5)(2, CartComponent_div_6_div_2_Template, 12, 3, "div", 6)(3, CartComponent_div_6_div_3_Template, 9, 6, "div", 7);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const items_r5 = ctx.ngIf;
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", items_r5.length === 0);
    \u0275\u0275advance();
...
var CartComponent = class _CartComponent {
    ...
    this.pedidoService.crearPedido(itemsDto).subscribe({
      next: (res) => {
        import_sweetalert2.default.fire({
          title: "\xA1Pedido Confirmado!",
          text: "Tu pedido ha sido realizado con \xE9xito.",
          icon: "success",
          background: "#1a1a1a",
          color: "#f8edda",
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CartComponent, selectors: [["app-cart"]], decls: 8, vars: 3, consts: [[1, "modal-overlay", 3, "click"], [1, "modal-content", 3, "click"], [1, "close-btn", 3, "click"], ["class", "cart-items", 4, "ngIf"], [1, "cart-items"], ["class", "empty-cart", 4, "ngIf"], ["class", "cart-item", 4, "ngFor", "ngForOf"], ["class", "cart-footer", 4, "ngIf"], [1, "empty-cart"], [1, "fas", "fa-shopping-basket"], [1, "cart-item"], [1, "item-info"], [1, "item-name"], [1, "item-price"], [1, "item-controls"], [1, "qty"], [1, "btn-remove", 3, "click"], [1, "fas", "fa-trash"], [1, "cart-footer"], [1, "total-row"], [1, "total-amount"], [1, "btn-confirm", 3, "click", "disabled"]], template: function CartComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0);
      \u0275\u0275listener("click", function CartComponent_Template_div_click_0_listener() {
        return ctx.closeRequest();
      });
      \u0275\u0275elementStart(1, "div", 1);
      \u0275\u0275listener("click", function CartComponent_Template_div_click_1_listener($event) {
        return $event.stopPropagation();
      });
      \u0275\u0275elementStart(2, "button", 2);
      \u0275\u0275listener("click", function CartComponent_Template_button_click_2_listener() {
        return ctx.closeRequest();
      });
      \u0275\u0275text(3, "\xD7");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(5, "Tu Carrito");
      \u0275\u0275elementEnd();
      \u0275\u0275template(6, CartComponent_div_6_Template, 4, 3, "div", 3);
      \u0275\u0275pipe(7, "async");
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(6);
      \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(7, 1, ctx.cartItems$));
    }
  }, dependencies: [CommonModule, NgForOf, NgIf, AsyncPipe, DecimalPipe], styles: ["\n\n.modal-overlay[_ngcontent-%COMP%] {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  background: rgba(0, 0, 0, 0.7);\n  backdrop-filter: blur(5px);\n  z-index: 1000;\n  display: flex;\n  justify-content: flex-end;\n  opacity: 0;\n  animation: _ngcontent-%COMP%_fadeIn 0.3s forwards;\n}\n@keyframes _ngcontent-%COMP%_fadeIn {\n  to {\n    opacity: 1;\n  }\n}\n.modal-content[_ngcontent-%COMP%] {\n  background: rgba(20, 20, 20, 0.95);\n  border-left: 1px solid rgba(237, 177, 16, 0.3);\n  width: 100%;\n  max-width: 450px;\n  height: 100%;\n  padding: 2rem;\n  box-shadow: -5px 0 25px rgba(0, 0, 0, 0.5);\n  display: flex;\n  flex-direction: column;\n  transform: translateX(100%);\n  animation: _ngcontent-%COMP%_slideIn 0.3s forwards;\n  position: relative;\n  color: #f8edda;\n}\n@keyframes _ngcontent-%COMP%_slideIn {\n  to {\n    transform: translateX(0);\n  }\n}\n.close-btn[_ngcontent-%COMP%] {\n  position: absolute;\n  top: 1rem;\n  right: 1.5rem;\n  background: none;\n  border: none;\n  color: rgba(248, 237, 218, 0.6);\n  font-size: 2rem;\n  cursor: pointer;\n  transition: color 0.2s;\n}\n.close-btn[_ngcontent-%COMP%]:hover {\n  color: #edb110;\n}\nh2[_ngcontent-%COMP%] {\n  color: #edb110;\n  margin-bottom: 2rem;\n  font-size: 1.8rem;\n  text-transform: uppercase;\n  letter-spacing: 1px;\n  border-bottom: 2px solid rgba(237, 177, 16, 0.2);\n  padding-bottom: 0.5rem;\n}\n.cart-items[_ngcontent-%COMP%] {\n  flex-grow: 1;\n  overflow-y: auto;\n  padding-right: 0.5rem;\n}\n.cart-items[_ngcontent-%COMP%]::-webkit-scrollbar {\n  width: 6px;\n}\n.cart-items[_ngcontent-%COMP%]::-webkit-scrollbar-thumb {\n  background: rgba(237, 177, 16, 0.3);\n  border-radius: 3px;\n}\n.cart-item[_ngcontent-%COMP%] {\n  background: rgba(255, 255, 255, 0.05);\n  border-radius: 12px;\n  padding: 1rem;\n  margin-bottom: 1rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border: 1px solid transparent;\n  transition: all 0.2s;\n}\n.cart-item[_ngcontent-%COMP%]:hover {\n  background: rgba(255, 255, 255, 0.08);\n  border-color: rgba(237, 177, 16, 0.2);\n}\n.cart-item[_ngcontent-%COMP%]   .item-info[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.3rem;\n}\n.cart-item[_ngcontent-%COMP%]   .item-info[_ngcontent-%COMP%]   .item-name[_ngcontent-%COMP%] {\n  font-weight: 600;\n  font-size: 1.1rem;\n  color: #f8edda;\n}\n.cart-item[_ngcontent-%COMP%]   .item-info[_ngcontent-%COMP%]   .item-price[_ngcontent-%COMP%] {\n  color: #edb110;\n  font-size: 0.95rem;\n}\n.cart-item[_ngcontent-%COMP%]   .item-controls[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  gap: 0.5rem;\n}\n.cart-item[_ngcontent-%COMP%]   .item-controls[_ngcontent-%COMP%]   .qty[_ngcontent-%COMP%] {\n  background: rgba(237, 177, 16, 0.2);\n  color: #edb110;\n  padding: 0.2rem 0.8rem;\n  border-radius: 20px;\n  font-weight: bold;\n  font-size: 0.9rem;\n}\n.cart-item[_ngcontent-%COMP%]   .item-controls[_ngcontent-%COMP%]   .btn-remove[_ngcontent-%COMP%] {\n  background: none;\n  border: none;\n  color: #ff3838;\n  cursor: pointer;\n  font-size: 0.85rem;\n  display: flex;\n  align-items: center;\n  gap: 0.3rem;\n  transition: color 0.2s;\n}\n.cart-item[_ngcontent-%COMP%]   .item-controls[_ngcontent-%COMP%]   .btn-remove[_ngcontent-%COMP%]:hover {\n  color: #ff6b6b;\n}\n.cart-item[_ngcontent-%COMP%]   .item-controls[_ngcontent-%COMP%]   .btn-remove[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n}\n.cart-footer[_ngcontent-%COMP%] {\n  margin-top: auto;\n  padding-top: 1.5rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.1);\n  background: inherit;\n}\n.cart-footer[_ngcontent-%COMP%]   .total-row[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1.5rem;\n}\n.cart-footer[_ngcontent-%COMP%]   .total-row[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:first-child {\n  font-size: 1.2rem;\n  color: rgba(248, 237, 218, 0.8);\n}\n.cart-footer[_ngcontent-%COMP%]   .total-row[_ngcontent-%COMP%]   .total-amount[_ngcontent-%COMP%] {\n  font-size: 1.8rem;\n  font-weight: bold;\n  color: #edb110;\n}\n.cart-footer[_ngcontent-%COMP%]   .btn-confirm[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 1rem;\n  background:\n    linear-gradient(\n      45deg,\n      #edb110,\n      rgb(241.9723320158, 193.1185770751, 62.0276679842));\n  color: #000;\n  border: none;\n  border-radius: 50px;\n  font-weight: 800;\n  font-size: 1.1rem;\n  cursor: pointer;\n  transition: transform 0.2s, box-shadow 0.2s;\n  box-shadow: 0 4px 15px rgba(237, 177, 16, 0.3);\n}\n.cart-footer[_ngcontent-%COMP%]   .btn-confirm[_ngcontent-%COMP%]:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 6px 20px rgba(237, 177, 16, 0.4);\n}\n.cart-footer[_ngcontent-%COMP%]   .btn-confirm[_ngcontent-%COMP%]:active {\n  transform: translateY(0);\n}\n.cart-footer[_ngcontent-%COMP%]   .btn-confirm[_ngcontent-%COMP%]:disabled {\n  background: #444;\n  color: #888;\n  cursor: not-allowed;\n  box-shadow: none;\n}\n.empty-cart[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  color: rgba(248, 237, 218, 0.4);\n}\n.empty-cart[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 3rem;\n  margin-bottom: 1rem;\n  opacity: 0.5;\n}\n/*# sourceMappingURL=cart.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CartComponent, [{
    type: Component,
    args: [{ selector: "app-cart", standalone: true, imports: [CommonModule], template: `<div class="modal-overlay" (click)="closeRequest()">\r
    <div class="modal-content" (click)="$event.stopPropagation()">\r
        <button class="close-btn" (click)="closeRequest()">&times;</button>\r
        \r
        <h2>Tu Carrito</h2>\r
        \r
        <div class="cart-items" *ngIf="(cartItems$ | async) as items">\r
            <div *ngIf="items.length === 0" class="empty-cart">\r
                <i class="fas fa-shopping-basket"></i>\r
                <p>No tienes productos en el carrito.</p>\r
            </div>\r
\r
            <div *ngFor="let item of items" class="cart-item">\r
                <div class="item-info">\r
                    <span class="item-name">{{ item.producto.nombre }}</span>\r
                    <span class="item-price">$ {{ item.producto.precio }}</span>\r
                </div>\r
                <div class="item-controls">\r
                    <span class="qty">x {{ item.cantidad }}</span>\r
                    <button class="btn-remove" (click)="removeItem(item.producto.id!)">\r
                        <i class="fas fa-trash"></i> Eliminar\r
                    </button>\r
                </div>\r
            </div>\r
\r
            <div class="cart-footer" *ngIf="items.length > 0">\r
                <div class="total-row">\r
                    <span>Total:</span>\r
                    <span class="total-amount">$ {{ total | number:'1.0-0' }}</span>\r
                </div>\r
                <button \r
                    class="btn-confirm" \r
                    [disabled]="isProcessing"\r
                    (click)="confirmOrder(items)">\r
                    {{ isProcessing ? 'Procesando...' : 'Confirmar Pedido' }}\r
                </button>\r
            </div>\r
        </div>\r
    </div>\r
</div>\r
`, styles: ["/* src/app/components/cart/cart.component.scss */\n.modal-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100vw;\n  height: 100vh;\n  background: rgba(0, 0, 0, 0.7);\n  backdrop-filter: blur(5px);\n  z-index: 1000;\n  display: flex;\n  justify-content: flex-end;\n  opacity: 0;\n  animation: fadeIn 0.3s forwards;\n}\n@keyframes fadeIn {\n  to {\n    opacity: 1;\n  }\n}\n.modal-content {\n  background: rgba(20, 20, 20, 0.95);\n  border-left: 1px solid rgba(237, 177, 16, 0.3);\n  width: 100%;\n  max-width: 450px;\n  height: 100%;\n  padding: 2rem;\n  box-shadow: -5px 0 25px rgba(0, 0, 0, 0.5);\n  display: flex;\n  flex-direction: column;\n  transform: translateX(100%);\n  animation: slideIn 0.3s forwards;\n  position: relative;\n  color: #f8edda;\n}\n@keyframes slideIn {\n  to {\n    transform: translateX(0);\n  }\n}\n.close-btn {\n  position: absolute;\n  top: 1rem;\n  right: 1.5rem;\n  background: none;\n  border: none;\n  color: rgba(248, 237, 218, 0.6);\n  font-size: 2rem;\n  cursor: pointer;\n  transition: color 0.2s;\n}\n.close-btn:hover {\n  color: #edb110;\n}\nh2 {\n  color: #edb110;\n  margin-bottom: 2rem;\n  font-size: 1.8rem;\n  text-transform: uppercase;\n  letter-spacing: 1px;\n  border-bottom: 2px solid rgba(237, 177, 16, 0.2);\n  padding-bottom: 0.5rem;\n}\n.cart-items {\n  flex-grow: 1;\n  overflow-y: auto;\n  padding-right: 0.5rem;\n}\n.cart-items::-webkit-scrollbar {\n  width: 6px;\n}\n.cart-items::-webkit-scrollbar-thumb {\n  background: rgba(237, 177, 16, 0.3);\n  border-radius: 3px;\n}\n.cart-item {\n  background: rgba(255, 255, 255, 0.05);\n  border-radius: 12px;\n  padding: 1rem;\n  margin-bottom: 1rem;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  border: 1px solid transparent;\n  transition: all 0.2s;\n}\n.cart-item:hover {\n  background: rgba(255, 255, 255, 0.08);\n  border-color: rgba(237, 177, 16, 0.2);\n}\n.cart-item .item-info {\n  display: flex;\n  flex-direction: column;\n  gap: 0.3rem;\n}\n.cart-item .item-info .item-name {\n  font-weight: 600;\n  font-size: 1.1rem;\n  color: #f8edda;\n}\n.cart-item .item-info .item-price {\n  color: #edb110;\n  font-size: 0.95rem;\n}\n.cart-item .item-controls {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  gap: 0.5rem;\n}\n.cart-item .item-controls .qty {\n  background: rgba(237, 177, 16, 0.2);\n  color: #edb110;\n  padding: 0.2rem 0.8rem;\n  border-radius: 20px;\n  font-weight: bold;\n  font-size: 0.9rem;\n}\n.cart-item .item-controls .btn-remove {\n  background: none;\n  border: none;\n  color: #ff3838;\n  cursor: pointer;\n  font-size: 0.85rem;\n  display: flex;\n  align-items: center;\n  gap: 0.3rem;\n  transition: color 0.2s;\n}\n.cart-item .item-controls .btn-remove:hover {\n  color: #ff6b6b;\n}\n.cart-item .item-controls .btn-remove i {\n  font-size: 0.8rem;\n}\n.cart-footer {\n  margin-top: auto;\n  padding-top: 1.5rem;\n  border-top: 1px solid rgba(255, 255, 255, 0.1);\n  background: inherit;\n}\n.cart-footer .total-row {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 1.5rem;\n}\n.cart-footer .total-row span:first-child {\n  font-size: 1.2rem;\n  color: rgba(248, 237, 218, 0.8);\n}\n.cart-footer .total-row .total-amount {\n  font-size: 1.8rem;\n  font-weight: bold;\n  color: #edb110;\n}\n.cart-footer .btn-confirm {\n  width: 100%;\n  padding: 1rem;\n  background:\n    linear-gradient(\n      45deg,\n      #edb110,\n      rgb(241.9723320158, 193.1185770751, 62.0276679842));\n  color: #000;\n  border: none;\n  border-radius: 50px;\n  font-weight: 800;\n  font-size: 1.1rem;\n  cursor: pointer;\n  transition: transform 0.2s, box-shadow 0.2s;\n  box-shadow: 0 4px 15px rgba(237, 177, 16, 0.3);\n}\n.cart-footer .btn-confirm:hover {\n  transform: translateY(-2px);\n  box-shadow: 0 6px 20px rgba(237, 177, 16, 0.4);\n}\n.cart-footer .btn-confirm:active {\n  transform: translateY(0);\n}\n.cart-footer .btn-confirm:disabled {\n  background: #444;\n  color: #888;\n  cursor: not-allowed;\n  box-shadow: none;\n}\n.empty-cart {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  color: rgba(248, 237, 218, 0.4);\n}\n.empty-cart i {\n  font-size: 3rem;\n  margin-bottom: 1rem;\n  opacity: 0.5;\n}\n/*# sourceMappingURL=cart.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CartComponent, { className: "CartComponent", filePath: "src/app/components/cart/cart.component.ts", lineNumber: 15 });
})();
...
function NavbarComponent_div_18_span_2_Template(rf, ctx) {
  if (rf & 1) {
...
function NavbarComponent_div_18_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function NavbarComponent_div_18_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleCart());
    });
    \u0275\u0275element(1, "i", 18);
    \u0275\u0275template(2, NavbarComponent_div_18_span_2_Template, 2, 1, "span", 19);
    \u0275\u0275pipe(3, "async");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", (tmp_1_0 = \u0275\u0275pipeBind1(3, 1, ctx_r1.cartService.cart$)) == null ? null : tmp_1_0.length);
  }
}
function NavbarComponent_app_cart_26_Template(rf, ctx) {
  if (rf & 1) {
...
var NavbarComponent = class _NavbarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NavbarComponent, selectors: [["app-navbar"]], decls: 27, vars: 5, consts: [[1, "navbar"], [1, "navbar-container"], [1, "logo-section"], ["src", "/assets/images/logonew.png", "alt", "Manoplas Logo", 1, "nav-logo"], [1, "brand-name"], [1, "nav-links"], ["routerLink", "/home", "routerLinkActive", "active"], ["routerLink", "/menu", "routerLinkActive", "active"], [4, "ngIf"], ["routerLink", "/contacto", "routerLinkActive", "active"], [1, "user-section"], ["class", "cart-trigger", 3, "click", 4, "ngIf"], [1, "user-info"], [1, "greeting"], [1, "username"], [1, "avatar-circle"], ["routerLink", "/mis-pedidos", "routerLinkActive", "active"], [1, "cart-trigger", 3, "click"], [1, "fas", "fa-shopping-cart"], ["class", "badge", 4, "ngIf"], [1, "badge"]], template: function NavbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(12, "Men\xFA de la semana");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(13, NavbarComponent_li_13_Template, 3, 0, "li", 8);
      \u0275\u0275elementStart(14, "li")(15, "a", 9);
      \u0275\u0275text(16, "Contactanos");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(17, "div", 10);
      \u0275\u0275template(18, NavbarComponent_div_18_Template, 4, 3, "div", 11);
      ...
      \u0275\u0275text(25);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(26, NavbarComponent_app_cart_26_Template, 1, 0, "app-cart", 8);
    }
    if (rf & 2) {
      \u0275\u0275advance(13);
  ...
  }, dependencies: [CommonModule, NgIf, AsyncPipe, RouterLink, RouterLinkActive, CartComponent], styles: ['\n\n[_nghost-%COMP%] {\n  display: block;\n  width: 100%;\n  position: fixed;\n  top: 0;\n  left: 0;\n  z-index: 1000;\n}\n.navbar[_ngcontent-%COMP%] {\n  background: rgba(20, 20, 20, 0.85);\n  backdrop-filter: blur(10px);\n  -webkit-backdrop-filter: blur(10px);\n  border-bottom: 1px solid rgba(237, 177, 16, 0.2);\n  padding: 0.8rem 2rem;\n  box-shadow: 0 4px 30px rgba(0, 0, 0, 0.3);\n}\n.navbar-container[_ngcontent-%COMP%] {\n  max-width: 1400px;\n  margin: 0 auto;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.logo-section[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  cursor: pointer;\n}\n.logo-section[_ngcontent-%COMP%]   .nav-logo[_ngcontent-%COMP%] {\n  height: 50px;\n  width: auto;\n  filter: drop-shadow(0 2px 4px rgba(0, 0, 0, 0.2));\n}\n.logo-section[_ngcontent-%COMP%]   .brand-name[_ngcontent-%COMP%] {\n  color: #f8edda;\n  font-size: 1.2rem;\n  font-weight: 700;\n  letter-spacing: 1px;\n}\n.nav-links[_ngcontent-%COMP%] {\n  list-style: none;\n  display: flex;\n  gap: 2.5rem;\n  margin: 0;\n  padding: 0;\n}\n.nav-links[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  text-decoration: none;\n  color: rgba(248, 237, 218, 0.7);\n  font-size: 0.95rem;\n  font-weight: 500;\n  transition: all 0.3s ease;\n  padding: 0.5rem 0;\n  position: relative;\n}\n.nav-links[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 0;\n  height: 2px;\n  background-color: #edb110;\n  transition: width 0.3s ease;\n}\n.nav-links[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover, \n.nav-links[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a.active[_ngcontent-%COMP%] {\n  color: #edb110;\n}\n.nav-links[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover::after, \n.nav-links[_ngcontent-%COMP%]   li[_ngcontent-%COMP%]   a.active[_ngcontent-%COMP%]::after {\n  width: 100%;\n}\n.user-section[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  padding-left: 2rem;\n  border-left: 1px solid rgba(248, 237, 218, 0.1);\n}\n.user-section[_ngcontent-%COMP%]   .cart-trigger[_ngcontent-%COMP%] {\n  position: relative;\n  margin-right: 1.5rem;\n  color: #f8edda;\n  font-size: 1.2rem;\n  cursor: pointer;\n  transition: transform 0.2s;\n}\n.user-section[_ngcontent-%COMP%]   .cart-trigger[_ngcontent-%COMP%]:hover {\n  transform: scale(1.1);\n  color: #edb110;\n}\n.user-section[_ngcontent-%COMP%]   .cart-trigger[_ngcontent-%COMP%]   .badge[_ngcontent-%COMP%] {\n  position: absolute;\n  top: -8px;\n  right: -8px;\n  background: #edb110;\n  color: #0a332e;\n  font-size: 0.7rem;\n  font-weight: bold;\n  width: 18px;\n  height: 18px;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.user-section[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  line-height: 1.2;\n}\n.user-section[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%]   .greeting[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  color: rgba(248, 237, 218, 0.5);\n}\n.user-section[_ngcontent-%COMP%]   .user-info[_ngcontent-%COMP%]   .username[_ngcontent-%COMP%] {\n  color: #f8edda;\n  font-weight: 600;\n  font-size: 0.9rem;\n}\n.user-section[_ngcontent-%COMP%]   .avatar-circle[_ngcontent-%COMP%] {\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  background: rgba(237, 177, 16, 0.2);\n  border: 1px solid #edb110;\n  color: #edb110;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: 700;\n  font-size: 1.1rem;\n  transition: transform 0.3s ease;\n}\n.user-section[_ngcontent-%COMP%]   .avatar-circle[_ngcontent-%COMP%]:hover {\n  transform: scale(1.05);\n  background: #edb110;\n  color: #0a332e;\n}\n/*# sourceMappingURL=navbar.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NavbarComponent, [{
    type: Component,
    args: [{ selector: "app-navbar", standalone: true, imports: [CommonModule, RouterLink, RouterLinkActive, CartComponent], template: '<nav class="navbar">\r\n  <div class="navbar-container">\r\n    <div class="logo-section">\r\n      <img src="/assets/images/logonew.png" alt="Manoplas Logo" class="nav-logo">\r\n      <span class="brand-name">MANOPLAS</span>\r\n    </div>\r\n\r\n    <ul class="nav-links">\r\n      <li><a routerLink="/home" routerLinkActive="active">Inicio</a></li>\r\n      <li><a routerLink="/menu" routerLinkActive="active">Men\xFA de la semana</a></li>\r\n      <li *ngIf="!isAdmin"><a routerLink="/mis-pedidos" routerLinkActive="active">Mis pedidos</a></li>\r\n      <li><a routerLink="/contacto" routerLinkActive="active">Contactanos</a></li>\r\n    </ul>\r\n\r\n    <div class="user-section">\r\n      <!-- Cart Trigger (User only) -->\r\n      <div class="cart-trigger" *ngIf="!isAdmin" (click)="toggleCart()">\r\n        <i class="fas fa-shopping-cart"></i>\r\n        <span class="badge" *ngIf="(cartService.cart$ | async)?.length as count">{{ count }}</span>\r\n      </div>\r\n\r\n      <div class="user-info">\r\n        <span class="greeting">Hola,</span>\r\n        <span class="username">{{ userName }}</span>\r\n      </div>\r\n      <div class="avatar-circle">\r\n        {{ userName.charAt(0) }}\r\n      </div>\r\n    </div>\r\n  </div>\r\n</nav>\r\n\r\n<!-- Cart Modal -->\r\n<app-cart *ngIf="showCart"></app-cart>\r\n', styles: ['/* src/app/components/navbar/navbar.component.scss */\n:host {\n  display: block;\n  width: 100%;\n  position: fixed;\n  top: 0;\n  left: 0;\n  z-index: 1000;\n}\n.navbar {\n  background: rgba(20, 20, 20, 0.85);\n  backdrop-filter: blur(10px);\n  -webkit-backdrop-filter: blur(10px);\n  border-bottom: 1px solid rgba(237, 177, 16, 0.2);\n  padding: 0.8rem 2rem;\n  box-shadow: 0 4px 30px rgba(0, 0, 0, 0.3);\n}\n.navbar-container {\n  max-width: 1400px;\n  margin: 0 auto;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.logo-section {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  cursor: pointer;\n}\n.logo-section .nav-logo {\n  height: 50px;\n  width: auto;\n  filter: drop-shadow(0 2px 4px rgba(0, 0, 0, 0.2));\n}\n.logo-section .brand-name {\n  color: #f8edda;\n  font-size: 1.2rem;\n  font-weight: 700;\n  letter-spacing: 1px;\n}\n.nav-links {\n  list-style: none;\n  display: flex;\n  gap: 2.5rem;\n  margin: 0;\n  padding: 0;\n}\n.nav-links li a {\n  text-decoration: none;\n  color: rgba(248, 237, 218, 0.7);\n  font-size: 0.95rem;\n  font-weight: 500;\n  transition: all 0.3s ease;\n  padding: 0.5rem 0;\n  position: relative;\n}\n.nav-links li a::after {\n  content: "";\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  width: 0;\n  height: 2px;\n  background-color: #edb110;\n  transition: width 0.3s ease;\n}\n.nav-links li a:hover,\n.nav-links li a.active {\n  color: #edb110;\n}\n.nav-links li a:hover::after,\n.nav-links li a.active::after {\n  width: 100%;\n}\n.user-section {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  padding-left: 2rem;\n  border-left: 1px solid rgba(248, 237, 218, 0.1);\n}\n.user-section .cart-trigger {\n  position: relative;\n  margin-right: 1.5rem;\n  color: #f8edda;\n  font-size: 1.2rem;\n  cursor: pointer;\n  transition: transform 0.2s;\n}\n.user-section .cart-trigger:hover {\n  transform: scale(1.1);\n  color: #edb110;\n}\n.user-section .cart-trigger .badge {\n  position: absolute;\n  top: -8px;\n  right: -8px;\n  background: #edb110;\n  color: #0a332e;\n  font-size: 0.7rem;\n  font-weight: bold;\n  width: 18px;\n  height: 18px;\n  border-radius: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.user-section .user-info {\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  line-height: 1.2;\n}\n.user-section .user-info .greeting {\n  font-size: 0.75rem;\n  color: rgba(248, 237, 218, 0.5);\n}\n.user-section .user-info .username {\n  color: #f8edda;\n  font-weight: 600;\n  font-size: 0.9rem;\n}\n.user-section .avatar-circle {\n  width: 40px;\n  height: 40px;\n  border-radius: 50%;\n  background: rgba(237, 177, 16, 0.2);\n  border: 1px solid #edb110;\n  color: #edb110;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-weight: 700;\n  font-size: 1.1rem;\n  transition: transform 0.3s ease;\n}\n.user-section .avatar-circle:hover {\n  transform: scale(1.05);\n  background: #edb110;\n  color: #0a332e;\n}\n/*# sourceMappingURL=navbar.component.css.map */\n'] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(NavbarComponent, { className: "NavbarComponent", filePath: "src/app/components/navbar/navbar.component.ts", lineNumber: 15 });
})();
...
sweetalert2/dist/sweetalert2.all.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-CEKYT777.js.map
